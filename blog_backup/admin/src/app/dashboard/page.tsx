...
export default function DashboardPage() {
  ...
  const handleHealthCheck = async () => {
    ...
    try {
      ...
      setHealthStatus({ success: false, data: error.response?.data || error.message });
    } finally {
              ...
              <div className="px-4 py-8 sm:px-0">
                ...
                <div className="mt-8 bg-white shadow overflow-hidden sm:rounded-lg">
                  <div className="px-4 py-5 sm:p-6">
                    ...
                    <div className="mt-2 max-w-xl text-sm text-gray-500">
                      <p>Check the backend API and database status.</p>
                    </div>
                    <div className="mt-5">
                      <button
                    ...
                    {healthStatus && (
                      <div className={`mt-4 p-4 rounded-md ${healthStatus.success ? 'bg-green-50 text-green-800' : 'bg-red-50 text-red-800'}`}>
                        <h4 className="text-sm font-medium mb-2">
                          {healthStatus.success ? 'System is healthy' : 'System is experiencing issues'}
                        </h4>
